...
<div class="col-md-8 col-md-offset-2">
	<form action="{{ route('posts.store') }}" method="post" id="formPost" enctype="multipart/form-data">
		{!!csrf_field()!!}
		<div class="form-group">
			<label for="title">Tên bài viết</label>
			<input type="text" name="title" class="form-control" placeholder="Title" id="title" onkeyup="generateSlug()">
			@if ($errors->has('title'))
				{{-- expr --}}
	...
	$(document).ready(function() {
		$('#formPost').validate({
			...
			messages: {
				...
				featured: {
					required: "<span style='color: red;'>Chọn một file ảnh!</span>"
				},
				content: {
